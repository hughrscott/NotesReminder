        ...
        tasks.extend(
            [
                ...
                RefreshTask(
                    ...
                    requires_auth=True,
                    enabled_flag="--execute-refresh",
                    timeout_seconds=_timeout_at_least(login_timeout + dialpad_sms_thread_limit * 10 + 300, 1200),
                ),
                RefreshTask(
                    name=f"dialpad_sms_web_{slug}",
                    command=[
                        py,
                    ...
                    requires_auth=True,
                    enabled_flag="--execute-refresh",
                    timeout_seconds=_timeout_at_least(login_timeout + dialpad_sms_thread_limit * 5 + 180, 900),
                ),
                RefreshTask(
                    ...
                    requires_auth=True,
                    enabled_flag="--execute-refresh",
                    timeout_seconds=_timeout_at_least(login_timeout + dialpad_sms_thread_limit * 20 + 300, 1200),
                ),
            ]
        )
