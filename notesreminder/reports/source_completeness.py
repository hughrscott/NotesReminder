...
from notesreminder.schema.lead_followup import ensure_lead_followup_schema, upsert_identity_match
...
def lead_gap_section(conn):
    ...
    return {
        ...
        "hubspot_only_unworked_rows": summary.get("hubspot_only_unworked_rows", 0),
        "hubspot_only_with_outreach_rows": summary.get("hubspot_only_with_outreach_rows", 0),
        "scheduled_trial_missing_pike13_rows": summary.get("scheduled_trial_missing_pike13_rows", 0),
