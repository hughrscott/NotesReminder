...
def pike13_summary(pike13):
    ...
    return [
        ...
        f"Report-backed first visit rows: {pike13.get('report_backed_first_visit_rows', 0)}",
        f"Event-enriched visit rows: {pike13.get('event_enriched_visit_rows', 0)}",
        f"Plan/pass rows: {pike13.get('plan_pass_rows', 0)}",
        f"Plan/conversion enriched rows: {pike13.get('plan_enrichment_rows', 0)}",
